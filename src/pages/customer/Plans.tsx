...
export default function Plans() {
  ...
  useEffect(() => {
    const fetchPlans = async () => {
      ...
      try {
        ...
        // ✅ Only send filters if they aren't the sentinel "all"/"default" values
        if (categoryFilter && categoryFilter !== 'all') params.property_category = categoryFilter;
        if (sortBy && sortBy !== 'default') params.ordering = sortBy;
  ...
  // ✅ Redirect unauthenticated users to login, then back here after login
  const handleSubscribeClick = (planId: number) => {
    if (!isAuthenticated) {
      navigate('/login', { state: { from: { pathname: `/plans/${planId}` } } });
    } else {
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              <SelectContent>
                {/* ✅ "all" sentinel instead of empty string */}
            ...
            >
              ...
              <SelectContent>
                {/* ✅ "default" sentinel instead of empty string */}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {plans.map((plan, index) => (
                ...
                >
                  ...
                  <CardFooter>
                    {/* ✅ "View Details" is always free — subscribe prompt handles auth */}
                    <Button
                      variant="outline"
